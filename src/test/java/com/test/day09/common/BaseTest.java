package com.test.day09.common;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.test.day09.pojo.CaseData;
import com.test.day09.util.JDBCUtil;
    ...
    public String replaceParam(String str){
        if(str != null) {
            ...
            while (matcher.find()) {
                ...
                System.out.println("环境变量的变量名:"+variableName);
                Object value = Environment.env.get(variableName);
                System.out.println("环境变量的value:"+value);
                //3、将字串subStr替换为上述的值
