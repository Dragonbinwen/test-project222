package com.test.day11.common;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.test.day11.pojo.CaseData;
import com.test.day11.util.JDBCUtil;
...
public class BaseTest {
    ...
    public Response request(CaseData caseData) {
        ...
        String assertSql = caseData.getAssertSql();
        ...
        //后置SQL中${XXX}替换
        afterSql = replaceParam(afterSql);
        ...
        if (method.equalsIgnoreCase("get")) {
            ...
            if(params != null) {
                ...
                res = req.get(url).then().extract().response();
            }
        } else if (method.equalsIgnoreCase("post")) {
            //执行post请求
            //判断是否为multipart/form-data请求头-文件上传
        ...
        extractSQL(afterSql);
        //SQL断言中${XXX}替换
        assertSql = replaceParam(assertSql);
        //执行SQL断言
        assertSQL(assertSql);
        return res;
    }
    ...
    public void assertSQL(String assertSql){
        if(assertSql != null){
            HashMap<String,Object> assertSqlMap = json2Map(assertSql);
    ...
    public void extractSQL(String sqlInfo){
        ...
        if(sqlInfo != null){
            HashMap<String,Object> sqlMap = json2Map(sqlInfo);
            ...
            for (String key: keys){
                ...
                logger.info("执行后置的SQL:"+sql);
                logger.info("得到的值:"+result);
            }
        }
    }
    ...
    public void extractResponse(Response res, String extractInfo){
        if(extractInfo != null) {
            ...
            for (String key : keys) {
                //key:变量名  value:提取表达式
                String value = (String) extractMap.get(key);
                //判断value的值，如果是bodystr，那么代表的是提取整个响应体字符串
                //否则的话，就是Gpath表达式，提取响应体中字段
                Object result = null;
